...
from src.models.match import DoppelMatch, EinzelMatch, Turnier
...
spielerListe = [
    Spieler(
        ...
        gegner_daten_einzel=[
            # Saison 2026/27 -- hier neue Turniere/Spiele eintragen, sobald sie stattgefunden haben.
    ...
    Spieler(
        ...
        gegner_daten_einzel=[
            ...
            Turnier("Düsseldorfer Stadtmeisterschaften 2025", [
            ...
            Turnier("Neujahrsturnier OSC Düsseldorf 2026", [
            ...
            Turnier("Offene Duisburger Stadtmeisterschaften 2026", [
            ...
            # Zählt nicht zur Bax-Berechnung, warum auch immer -- trotzdem als Turnier erfasst
            Turnier("Westdeutsche Meisterschaften U22 2026", [
                EinzelMatch(get_bax("Johann", "Sufryd", "1. BV Mülheim", "einzel", vorsaison(SAISON_2025_26)), [0,2]),
            ]),
            Turnier("Ostwestfalenpokal 2026", [
            ...
            Turnier("Blau-Weißer Alpen Cup 2026", [
            ...
            Turnier("4. Schwebebahn Cup 2026", [
            ...
            Turnier("Beuler Summer Games 2026", [
                EinzelMatch(get_bax("Jan", "Hammer", "FC Langenfeld", "einzel", vorsaison(SAISON_2025_26)), [2,0]),
